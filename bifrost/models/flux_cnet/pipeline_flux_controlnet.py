...
from bifrost.models.flux_cnet.controlnet_flux import FluxControlNetModel, FluxMultiControlNetModel
...
class FluxControlNetPipeline(DiffusionPipeline, FluxLoraLoaderMixin, FromSingleFileMixin, FluxIPAdapterMixin):
    ...
    def __call__(
            ...
            for i, t in enumerate(timesteps):
                ...
                if control_image is not None:
                    controlnet_block_samples, controlnet_single_block_samples = self.controlnet(
                        ...
                        controlnet_cond=control_image.to(self.device),
                ...
                # print("latents.max/min", latents.max(), latents.min())
        ...
        if output_type == "latent":
            ...
            # print("latents before vae", latents.max(), latents.min())

            image = self.vae.decode(latents, return_dict=False)[0]

            # print("image after vae", image.max(), image.min(), image)
